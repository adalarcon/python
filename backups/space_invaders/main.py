...
BACKGROUND_SOUND = "./pygames/space_invaders/assets/sounds/background.wav"
...
ENEMY_IMG = './pygames/space_invaders/assets/img/alien1.png'
...
for i in range(num_of_enemies):
    enemy_img.append(pygame.image.load(ENEMY_IMG))
    enemy_x.append(random.randint(0, SCREEN_WIDTH - 64))
    enemy_y.append(random.randint(0, SCREEN_HEIGHT // 2))
    enemy_x_velocity.append(ENEMY_VELOCITY)
